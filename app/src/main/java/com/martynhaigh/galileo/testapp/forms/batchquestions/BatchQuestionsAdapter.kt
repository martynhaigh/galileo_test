...
class BatchQuestionsAdapter : RecyclerView.Adapter<BatchBaseViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BatchBaseViewHolder {
    ...
    class FreeTextViewHolder(itemView: View) : BatchBaseViewHolder(itemView) {
    ...
    class MultipleChoiceViewHolder(itemView: View) : BatchBaseViewHolder(itemView) {
        var title: TextView = itemView.findViewById(R.id.title)
    ...
    override fun onBindViewHolder(holder: BatchBaseViewHolder, position: Int) {
        holder.bind(
